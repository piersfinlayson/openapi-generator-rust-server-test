...
- API version: 0.1.0
- Build date: 2019-03-16T13:53:54.656Z[GMT]
...
```
cargo run --example client AGet
cargo run --example client APost
```
...
------------- | ------------- | -------------
[**a_get**](docs/default_api.md#a_get) | **GET** /a_get | 
[**a_post**](docs/default_api.md#a_post) | **POST** /a_post/{arg} | 
